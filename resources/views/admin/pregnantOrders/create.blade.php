...
@section('title')
    Hamiləlik məzuniyyəti ilə bağlı əmri əlavə et
@endsection
@section('page_styles')
    ...
    <main id="main-container">
        ...
        <div class="content">
            <div class="block-content block-content-full">
                <form action="{{ route('admin.pregnantOrders.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <textarea class="form-control" id="main_part_of_order" name="main_part_of_order"
                                      placeholder="Hamiləlik məzuniyyəti vərəqəsi Seriya SN010000 №099999...">{{ old('main_part_of_order') }}</textarea>
