                ...
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                    <div class="flex-grow-1">
                        <h1 class="h3 fw-bold mb-2">
                            İşçilər - {{ $servedCompany->company_name }}
                        </h1>
                    </div>
                </div>
            </div>
        ...
        <div class="content w-100">
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">İŞÇİLƏR</h3>
                ...
                <div class="block-content">
                    <table class="js-table-sections table table-sm table-vcenter">
                        ...
                        @foreach ($employees  as $employee)
                            <tr>
                                <th class="text-center" scope="row">{{ $employees->firstItem() + $loop->index }}</th>
                                <td class="fs-sm">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="javascript:void(0)"
                                           ...
                                           data-bs-target="#modal-block-normal{{$employee->id}}">
