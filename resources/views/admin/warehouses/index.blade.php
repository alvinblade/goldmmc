                ...
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                    <div class="flex-grow-1">
                        <h1 class="h3 fw-bold mb-2">
                            Anbarlar - {{ $servedCompany->company_name }}
                        </h1>
                    </div>
                </div>
            </div>
        ...
        <div class="content w-100">
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">ANBARLAR</h3>
                    <a data-bs-toggle="modal"
                       data-bs-target="#modal-block-warehouse-create" class="btn btn-primary">
                ...
                <div class="block-content">
                    <table class="table table-hover table-vcenter">
                        ...
                        @foreach ($warehouses as $warehouse)
                            <tr>
                                <th class="text-center" scope="row">{{ $warehouses->firstItem() + $loop->index }}</th>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="javascript:void(0)"
                                           ...
                                           data-bs-target="#modal-block-warehouse-edit{{$warehouse->id}}">
                            ...
                            <!-- Normal Block Modal -->
                            <div class="modal" id="modal-block-warehouse-edit{{$warehouse->id}}" tabindex="-1"
                                 role="dialog"
                                 aria-labelledby="modal-block-warehouse-edit{{$warehouse->id}}" aria-hidden="true">
                                        ...
                                        <div class="block block-rounded block-transparent mb-0">
                                            ...
                                            <div class="block-content fs-sm pt-0">
                                                <form
                                                    ...
                                                    method="POST" id="updateForm{{$warehouse->id}}">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="my-4">
                                            ...
                                            <div class="block-content block-content-full text-end bg-body">
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary"
                                                        onclick="$('#updateForm{{$warehouse->id}}').submit()">
                                                    Təsdiqlə
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <!-- Normal Block Modal -->
                    <div class="modal" id="modal-block-warehouse-create" tabindex="-1"
                         role="dialog"
                         aria-labelledby="modal-block-warehouse-create" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="block block-rounded block-transparent mb-0">
                                    <div class="block-header block-header-default">
                                        <h3 class="block-title">ANBAR ƏLAVƏ ET</h3>
                                        <div class="block-options">
                                            <button type="button" class="btn-block-option"
                                                    data-bs-dismiss="modal" aria-label="Close">
                                                <i class="fa fa-fw fa-times"></i>
