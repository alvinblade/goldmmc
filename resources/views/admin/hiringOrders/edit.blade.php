    ...
    <main id="main-container">
        ...
        <div class="content">
            <div class="block-content block-content-full">
                <form action="{{ route('admin.hiringOrders.update', $hiringOrder->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-3 mb-4">
                            ...
                            <input type="text" class="js-flatpickr form-control" id="start_date"
                                   ...
                                   value="{{ old('start_date', $hiringOrder->start_date) }}">
                            @error('start_date')
                            ...
                            <select class="form-select" id="employee_id" name="employee_id">
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}"
                                        @selected(old('employee_id', $hiringOrder->employee_id) == $employee->id)>
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <input type="number" class="form-control" id="salary" name="salary"
                                   placeholder="Maaş" value="{{ old('salary', $hiringOrder->salary) }}">
                            @error('salary')
                            <div class="fs-6 text-danger">
                                {{ $message }}
                            </div>
